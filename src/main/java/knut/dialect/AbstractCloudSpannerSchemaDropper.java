...
abstract class AbstractCloudSpannerSchemaDropper extends SchemaDropperImpl {
  private final AbstractCloudSpannerSchemaManagementTool tool;

  AbstractCloudSpannerSchemaDropper(AbstractCloudSpannerSchemaManagementTool tool,
  ...
  public void doDrop(Metadata metadata, ExecutionOptions options, SourceDescriptor sourceDescriptor,
    ...
    if (metadata instanceof MetadataImpl) {
      Database original = tool.injectCloudSpannerDatabase((MetadataImpl) metadata, false);
